...
class RootCause:
    ...
    file_path: Optional[str] = None  # 関連ファイル
    line_number: Optional[int] = None  # 行番号
...
class AnalysisResult:
    ...
    tokens_used: Optional[TokenUsage] = None  # 使用トークン数
...
class ProviderConfig:
    ...
    name: str  # プロバイダー名
    api_key: str  # APIキー
    base_url: Optional[str] = None  # ベースURL
    ...
    rate_limit_per_minute: Optional[int] = None  # 分あたりのレート制限
...
class AnalyzeOptions:
    ...
    log_file: Optional[str] = None  # ログファイルパス
    provider: Optional[str] = None  # プロバイダー指定
    model: Optional[str] = None  # モデル指定
    custom_prompt: Optional[str] = None  # カスタムプロンプト
